...
export default function Step5CareerChannel({ formData, setFormData }) {
  ...
  const isBekerjaAtauWiraswasta = formData.f8 === "1" || formData.f8 === "3";
  const isPekerjaanTidakSesuai =
    formData.f8 === "3" ||
    formData.f14 === "4" ||
    formData.f14 === "5";
  ...
  return (
    <div className="space-y-5 sm:space-y-8 animate-fade-in text-slate-800">
      ...
      {isBekerjaAtauWiraswasta && isPekerjaanTidakSesuai && (
